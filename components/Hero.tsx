...
/**
 * Full-viewport dark hero with an animated blue→violet gradient glow.
 * Massive fluid headline, dual CTAs, a thin stat strip and a scroll cue.
 */
  ...
  return (
    ...
    >
      ...
      <div className="container-x relative z-10 flex flex-col items-center text-center">
        ...
        >
          The School Built for the{" "}
          <span className="bg-brand-gradient bg-clip-text text-transparent">AI Generation</span>
        </motion.h1>
        ...
        >
          <Stat value="2" label="Streams" />
          <span className="hidden h-4 w-px bg-white/15 sm:block" aria-hidden="true" />
          <Stat value="30" label="Seats Each" />
          <span className="hidden h-4 w-px bg-white/15 sm:block" aria-hidden="true" />
          <Stat value="100%" label="SCOLE Certified" />
        </motion.div>
      </div>
